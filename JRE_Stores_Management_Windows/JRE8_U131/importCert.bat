...
keytool -J-Duser.language=en -keystore %SYS_TRUSTED_SITE_CERT% -storepass:file store-pass.txt -storetype %STORE_TYPE% -importcert -file ..\Certificates\MyCompany\Corporate-PKI\my-cert.cer -alias my-cert -noprompt -v
