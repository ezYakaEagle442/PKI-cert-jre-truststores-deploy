...
set PATH=%JRE_BIN%;%PATH%

set JDK_SECURITY_FOLDER="C:\Program Files\Java\jdk-9.0.1\lib\security"
...
REM Modify SYS_STOREPASS_NEW value to the content of file store-pass.txt, ex: Str2Pa@ss911+++
set SYS_STOREPASS_NEW=changeit
