...
# test
# keytool -list -storepass $SYS_STOREPASS_NEW -keystore $SYS_TRUSTED_CA
# keytool -list -storepass $SYS_STOREPASS_NEW -keystore $SYS_TRUSTED_SITE_CA 

# keytool -list -storepass $SYS_STOREPASS_NEW -keystore $SYS_TRUSTED_CERT 
# keytool -list -storepass $SYS_STOREPASS_NEW -keystore $SYS_TRUSTED_SITE_CERT 
# keytool -list -storepass $SYS_STOREPASS_NEW -keystore $SYS_CLIENT_AUTH_CERT 